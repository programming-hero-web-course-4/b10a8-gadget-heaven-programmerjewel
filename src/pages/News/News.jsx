...
const Blog = () => {
  return (
    <div className="md:py-10 py-6 bg-gray-100">
      <h2 className="text-center font-bold text-lgl md:text-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-6 mx-8">
        <div className="border border-gray-300 p-4 rounded-xl flex gap-4">
          <div className="flex flex-col gap-2">
            ...
            <a className="underline font-semibold text-violet-600 text-sm" href="#">More Info</a>
          </div>
          <img
        ...
        <div className="border border-gray-300 p-4 rounded-xl flex gap-4">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-gray-500 font-light">
              ...
              very lightweight.
            </p><a className="underline font-semibold text-violet-600 text-sm" href="#">More Info</a>
          </div>
          <img
            className="w-30 h-30 rounded-lg"
            src={gamingLaptop}
        ...
        <div className="border border-gray-300 p-4 rounded-xl flex gap-4">
          <div className="flex flex-col gap-2">
            <h2 className="font-semibold text-lg">Whats wrong with new Macbook?</h2>
            <p className="text-gray-500 font-light">
